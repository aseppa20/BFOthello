...
public class CheckForLegalMoves {
    private Board board;
    ...
    public ArrayList<Tuple<Integer, Integer>> doWalks(Integer x, Integer y, Tile.State turn) {
    ...
    public ArrayList<Tuple<Integer, Integer>> doWalks(Integer x, Integer y, Tile.State turn, Board board) {
        this.board = board;
        return doWalks(x, y, turn);
    }
